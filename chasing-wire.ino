...
void setup() {                
  ...
  pinMode(channelE, OUTPUT);
  pinMode(channelF, OUTPUT);
  pinMode(channelG, OUTPUT);
  pinMode(channelH, OUTPUT);  
  pinMode(13, OUTPUT);    
...
void loop() 
{
  ...
  wire1.Update();
//  wire2.Update();
 digitalWrite(channelE, HIGH);
 digitalWrite(channelF, HIGH);
 digitalWrite(channelG, HIGH);
 digitalWrite(channelH, HIGH);
